    ...
    <div class="container contact-info__grid">
        <div class="contact-info__left">
            <div class="contact-info__card contact-info__card--reach">
                <h2 class="contact-info__card-title">Reach us directly</h2>
                <?php if ($whatsapp): ?>
                    <a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>" class="contact-info__whatsapp-button" target="_blank" rel="noopener noreferrer">
                        ...
                        <span class="contact-info__whatsapp-text">
                            ...
                            <?php if ($phone_display): ?>
                                <small><?php echo esc_html($phone_display); ?> &middot; fastest reply</small>
                            <?php endif; ?>
                        </span>
                    </a>
                <?php endif; ?>
            ...
            <?php if ($delivery_text): ?>
                <div class="contact-info__card contact-info__card--delivery">
                    <h2 class="contact-info__card-title">Delivery</h2>
